...
router.post('/', async (req, res) => {
  ...
  Distribute shifts fairly and consider any relevant preferences from the manager description.and shift_id should be between s1-s300, is same for all of them in  this prompt and in a different prompt the shift-id is changed, this is used to indentify  each shift plane that was made  , so we can display cards for each work plan 
  Return format:
  [
    { "shift_date": "YYYY-MM-DD", "assigned_to": "E101", "shift_group": "Group-1","shift_id":"[s1-s300]" },
    ...
  ]
  `;
